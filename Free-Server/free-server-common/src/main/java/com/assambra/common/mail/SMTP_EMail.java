...
import com.assambra.common.mail.modes.MailModeNoAuthentication;
import com.assambra.common.mail.modes.MailModeSSL;
import com.assambra.common.mail.modes.MailModeTLS;
...
public class SMTP_EMail extends EzyLoggable
{
    ...
    private void getMailProperties()
    {
        try(InputStream inputStream = EzyAnywayInputStreamLoader.builder()
                .context(getClass())
                .build()
                .load("free-server-common-config.properties")
        )
        {

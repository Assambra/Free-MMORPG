package com.assambra.game.plugin;

import com.assambra.game.common.constant.CommonConstants;
...
public class PluginEntry extends EzyDefaultPluginEntry {
    ...
    protected void preConfig(EzyPluginContext ctx) {
        logger.info("\n=================== free-game-server PLUGIN START CONFIG ================\n");
    }

    @Override
    protected void postConfig(EzyPluginContext ctx) {
        logger.info("\n=================== free-game-server PLUGIN END CONFIG ================\n");
    }
    ...
    protected String[] getScanablePackages() {
        return new String[]{
            "com.assambra.game.common",
            "com.assambra.game.plugin"
        };
    }
}

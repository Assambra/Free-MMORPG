package com.assambra.game.common.masterserver.manager;

import com.assambra.game.common.masterserver.constant.Commands;
...
public class SynchronizedUnityRoomManager<R extends UnityRoom> extends AbstractRoomManager<R> {
    ...
    protected SynchronizedUnityRoomManager(Builder<?, ?> builder) {
        super(builder);
    }
    ...
    public static class Builder<R extends UnityRoom, B extends Builder<R, B>>
